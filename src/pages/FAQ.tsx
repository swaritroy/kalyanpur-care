...
const faqs = [
  ...
  { q: "Where exactly is Trusted Medical Hall located in Kalyanpur?", a: "We are located in Chausima, Kalyanpur, at Rampreet Rai Ji's residence — easy to find near the local landmark. Tap the Get Directions button on the Contact page for Google Maps navigation." },
...
const FAQ = () => (
  <SiteLayout>
    ...
    <PageHero title="Frequently Asked Questions"
      subtitle="Everything you need to know before your visit to Trusted Medical Hall." />
