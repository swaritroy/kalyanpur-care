...
const posts = [
  ...
  { img: diabetes, tag: "Chronic Care", title: "Managing Diabetes: Diet Tips for a North Indian Lifestyle", excerpt: "Living with diabetes doesn't mean giving up all your favourite foods. Dr. Aditya shares practical tips for managing your diet..." },
...
const HealthTips = () => (
  <SiteLayout>
    ...
    <LeadPeWidget heading="Want Personalised Health Advice? Talk to Dr. Aditya." />
  </SiteLayout>
);
